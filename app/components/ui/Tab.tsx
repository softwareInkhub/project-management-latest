    ...
    <div
      className={`flex items-center space-x-2 px-4 py-2 text-sm font-medium cursor-pointer transition-all duration-200 border-b-2 ${
        isActive
          ...
          : 'bg-gray-50 dark:bg-gray-600 text-gray-600 dark:text-gray-300 border-transparent hover:bg-gray-100 dark:hover:bg-gray-500 hover:text-gray-800 dark:hover:text-white'
      } ${className}`}
      onClick={onClick}
    >
